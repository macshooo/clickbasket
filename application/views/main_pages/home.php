        ...
        <div class="container">
          <div class="slider-item-inner">
            <div class="slider-item-caption-left slider-item-caption-white" style="text-shadow: 2px 2px 4px #000000;">
              <h4 class="slider-item-caption-title">New Nokia Lumia</h4>
              <p class="slider-item-caption-desc">Try out 2015 Top Windows Smartphone</p><a class="btn btn-lg btn-ghost btn-white" href="#">Shop Now</a>
            </div>
    ...
    <div class="row" data-gutter="15">
      <div class="col-md-2">
        <a class="banner-category" href="#">
          <img class="banner-category-img-full" src="<?php echo base_url().'assets/img/ps_sample_banner.png'?>" alt="Image Alternative text" title="Image Title" />
          <h5 class="banner-category-title">SM SaveMore</h5>
            <!-- <p class="banner-category-desc">483 products</p> -->
        </a>
      </div>
    </div>
    <hr/>
      <h3 class="widget-title">Most Popular Products</h3>
        <div class="owl-carousel owl-loaded owl-nav-out" data-options='{"items":5,"loop":true,"nav":true}'>
          ...
          <div class="owl-item">
            <div class="product  owl-item-slide">
              <ul class="product-labels"></ul>
                <div class="product-img-wrap">
                  <img class="product-img" src="<?php echo base_url().'assets/img/product_img/4.png'; ?>" alt="Image Alternative text" title="Image Title" />
                </div>
                <a class="product-link" href="#"></a>
                <div class="product-caption">
                  <ul class="product-caption-rating">
                  ...
                  <h5 class="product-caption-title">Pen</h5>
            ...
            <div class="owl-item">
              <div class="product  owl-item-slide">
                <ul class="product-labels"></ul>
                <div class="product-img-wrap">
                  <img class="product-img" src="<?php echo base_url().'assets/img/product_img/5.png'; ?>" alt="Image Alternative text" title="Image Title" />
                </div>
                <a class="product-link" href="#"></a>
                  <div class="product-caption">
                    <ul class="product-caption-rating">
                    ...
                    <h5 class="product-caption-title">Pineapple</h5>
              ...
              <div class="owl-item">
                <div class="product  owl-item-slide">
                        <ul class="product-labels"></ul>
                        <div class="product-img-wrap">
                            <img class="product-img" src="<?php echo base_url().'assets/img/product_img/1.png'; ?>" alt="Image Alternative text" title="Image Title" />
                        </div>
                        <a class="product-link" href="#"></a>
                        <div class="product-caption">
                            <ul class="product-caption-rating">
                            ...
                            <h5 class="product-caption-title">Lays Classic Flavor</h5>
                ...
                <div class="owl-item">
                    <div class="product  owl-item-slide">
                        <ul class="product-labels"></ul>
                        <div class="product-img-wrap">
                            <img class="product-img" src="<?php echo base_url().'assets/img/product_img/2.png'; ?>" alt="Image Alternative text" title="Image Title" />
                        </div>
                        <a class="product-link" href="#"></a>
                        <div class="product-caption">
                            <ul class="product-caption-rating">
