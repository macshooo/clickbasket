<?php foreach ($marketcat as $category){ ?>
            ...
            <ul class="dropdown-menu-items-list">
              <?php foreach ($marketsubcat as $subcategory){
                if($subcategory->category_id == $category->category_id){ ?>
                  <li>
                    <a href="<?php echo site_url('listproductscontroller/index?id='.$subcategory->subcategory_id); ?>"><?php echo $subcategory->subcategory_name;?></a>
                  </li>
                <?php }
              }?>
            </ul>
